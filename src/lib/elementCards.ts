/**
 * Brawl element deck — 67 hand cards. Shapes map to elements at the seam.
 */
...
/** Sixty-seven cards with seam shapes for multi-activation hands. */
export const ELEMENT_CARDS: CardDefinition[] = [
  ...
  el("el-05", "Blaze", 4, "square", "circle", "If activated: 2x damage, no burn."),
  ...
  el("el-11", "Glacia", 2, "circle", "hexagon", "If activated: apply chill twice."),
  ...
  el("el-21", "Jolt", 3, "star", "square", "If activated: instant chip damage."),
  el("el-22", "Surge", 3, "star", "circle", "If activated: deals 2x chip."),
  el("el-23", "Static", 1, "circle", "star", "If activated: thaw 1 chill after hit."),
  el("el-24", "Arc", 3, "star", "diamond", "If activated: ignores 2 shield."),
  ...
  el("el-34", "Scorch", 3, "square", "diamond", "If activated: +1 if foe is burning."),
  ...
  el("el-37", "Bitter", 2, "circle", "diamond", "If activated: +shield and 1 chill."),
  el("el-38", "Frostbite", 2, "circle", "hexagon", "If activated: heal you 1."),
  el("el-39", "Hail", 3, "circle", "star", "If activated: +1 per 4 chill on foe."),
  ...
  el("el-44", "Overload", 3, "star", "diamond", "If activated: deals 2x damage."),
  ...
  el("el-46", "Venin", 1, "triangle", "diamond", "Snapped: value becomes 2."),
  el(
    "el-47",
    "Rot",
    2,
    "triangle",
    "diamond",
    "If activated: ignores 1 shield.",
    { allowedShapes: ["diamond"] },
  ),
  ...
  el(
    ...
    "square",
    "square",
    "Right seam: any shape; seam power -1.",
  ...
  el(
    ...
    "square",
    "square",
    "Left seam: any shape; seam power -1.",
  ...
  el("el-55", "Chilltouch", 2, "circle", "hexagon", "If activated: +1 chill if foe is chilled."),
  el("el-56", "Black Ice", 2, "circle", "diamond", "If activated: ignores 1 shield."),
  ...
  el(
    ...
    "triangle",
    "star",
    "Solo: deals 2, stacks 1 poison. If activated: stacks 2 poison.",
  ),
  el(
    "el-65",
    "Hemlock Needle",
    ...
    "triangle",
    "square",
    "Solo: deals printed chip. If activated: stacks 1 poison.",
  ),
  // Ren dual-damage freeze (ice fauna)
  el(
    "el-66",
    "Snow Hare",
    2,
    "circle",
    "star",
    "Solo: deals 2, 1 chill. If activated: 1 chill.",
  ),
  el(
    "el-67",
    "Frost Mite",
    ...
    "circle",
    "square",
    "Solo: deals 2, 1 chill. If activated: 2 chill.",
  ),
  // Volta barrier + solo shock
  el(
    "el-68",
    "Faraday Cage",
    2,
    "star",
    "diamond",
    "Solo: deals 3 shock. If activated: +4 barrier and shock chip.",
  ),
  el(
    "el-69",
    "Static Ward",
    ...
    "star",
    "hexagon",
    "Solo: deals printed shock. If activated: +3 barrier and shock chip.",
  ),
];
